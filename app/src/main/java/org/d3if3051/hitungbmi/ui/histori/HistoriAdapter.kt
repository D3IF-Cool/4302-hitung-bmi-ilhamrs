...
import org.d3if3051.hitungbmi.R
import org.d3if3051.hitungbmi.data.HitungBmi
import org.d3if3051.hitungbmi.databinding.ItemHistoriBinding
...
class HistoriAdapter : RecyclerView.Adapter<HistoriAdapter.ViewHolder>() {
    ...
    class ViewHolder(
        ...
        fun bind(item: BmiEntity) = with(binding){
            ...
            val stringGender = if (item.isMale) R.string.pria else R.string.wanita
            genderTextView.text = root.context.getString(stringGender)
